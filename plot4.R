...
par(mfrow = c(2,2) )
plot(my_data$dt,my_data$Global_active_power,ylab='Global Active Power',xlab='',t='l')
plot(my_data$dt,my_data$Voltage,ylab='Voltage',xlab='datetime',t='l')
...
plot(my_data$dt,my_data$Global_reactive_power,ylab='Global_reactive_power',xlab='datetime',t='l')
dev.off()